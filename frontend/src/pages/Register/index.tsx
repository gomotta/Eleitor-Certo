        ...
        <div className="relative z-10 flex flex-col h-full p-12">
          ...
          <div className="mt-20">
            <h1 className="text-[2.1rem] font-bold text-white leading-[1.2] tracking-tight">
              Comece sua<br />campanha com<br />inteligência.
            </h1>
            <p className="text-white/60 mt-4 text-sm leading-relaxed max-w-xs">
              Crie sua conta gratuitamente e acesse o melhor em análise e estratégia eleitoral.
            </p>
          ...
          <p className="mt-auto text-white/25 text-xs">
            © 2025 Eleitor Certo. Todos os direitos reservados.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center bg-white px-6 py-12">
        ...
        <div className="w-full max-w-[360px]">
          <div className="mb-8 hidden lg:flex lg:flex-col lg:items-center lg:text-center">
            ...
            <p className="text-gray-500 text-sm mt-1.5">Preencha os dados para começar gratuitamente</p>
          </div>
